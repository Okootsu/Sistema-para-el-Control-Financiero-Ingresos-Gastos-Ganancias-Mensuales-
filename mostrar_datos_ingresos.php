...
<body>
    ...
    <!-- Contenedor para mostrar la informacion de la tabla de ingresos  -->
    <div class="contenedor mostrar_informacion">
        ...
        # se realiza donde el campo cedula de la tabla ingresos (i) coincide con el campo cedula de la tabla usuarios (u)
        $sql = $connect->query("SELECT i.*, u.nombre AS nombre_usuario FROM ingresos i JOIN usuarios u ON i.cedula = u.cedula");
        ...
        if ($sql->num_rows > 0) {
            ...
            while ($row = $sql->fetch_array()) {
                ...
                <td><?=$fecha?></td>
                <td class='action'> <a class='editar' id='editar' href='php/editar_registro_ingresos.php?id=<?=$id?>'>Editar</a> <a class='eliminar' id='eliminar' onclick='eliminar_ingreso(<?=$id?>)'>Eliminar</a> </td>
                </tr>
                <?php
            }
            ?>
